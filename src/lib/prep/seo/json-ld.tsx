...
export function amirantCourseJsonLd(baseUrl: string): JsonLdObject {
  ...
  return {
    ...
    description:
      ...
      `${totalLessons} שיעורים, תרגול אדפטיבי, וסימולציות מלאות בטיימר. הקורס עצמאי ואינו רשמי של מאל״ו.`,
...
export function amirantFaqJsonLd(): JsonLdObject {
  const faqs = [
    ...
    {
      q: "האם PREPARE מבטיח פטור מאנגלית?",
      a: "לא. PREPARE הוא קורס הכנה עצמאי. ציון, פטור מקורסי אנגלית וקבלה ללימודים נקבעים במבחן אמירנט הרשמי של מאל״ו ובמדיניות המוסד.",
    },
    {
      q: "האם מבחן הרמה באתר הוא ציון אמירנט?",
      a: "לא. מבחן הרמה נותן הערכת רמה משוערת ממיפוי האחוז בסגנון הסולם 50–150, ואינו ציון רשמי.",
    },
    {
      q: "האם יש הקראה קולית באמירנט?",
      a: "כן. מרפורמת אפריל 2026 כל נבחן יכול להפעיל תוכנת הקראה (Text-to-Speech) ולשמוע את הטקסטים במבחן - ללא צורך באישור מיוחד. בקורס, קטעי תרגול השמיעה מוקלטים בקול סינתטי.",
    },
  ];
