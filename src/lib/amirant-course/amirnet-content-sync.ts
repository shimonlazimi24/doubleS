...
const SIM: ManifestModule = {
  ...
  lessons: [
    ...
    { id: "lesson.sim.04", title: "סימולציה 1 — Baseline", kind: "text", estimatedMinutes: 45 },
    { id: "lesson.sim.05", title: "סימולציה 2 — Warmup", kind: "text", estimatedMinutes: 45 },
    { id: "lesson.sim.06", title: "סימולציה 3 — Challenge", kind: "text", estimatedMinutes: 45 },
    { id: "lesson.sim.07", title: "סימולציה 4 — Final", kind: "text", estimatedMinutes: 45 },
  ],
  practiceSets: [],
  quizzes: [],
};
