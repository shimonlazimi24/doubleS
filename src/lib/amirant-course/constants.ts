...
export const LS_ANALYTICS = "amirant-course:analytics:v1";
export const LS_CROSS_TEST = "amirant-course:cross-test:v1";
export const LS_PROGRESS = "amirant-course:progress:v1";
