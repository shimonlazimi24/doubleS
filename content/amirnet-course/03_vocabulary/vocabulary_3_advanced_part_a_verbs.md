...
## חלק א': 150 פעלים (Verbs) - רמה מתקדמת

**מבנה:** 150 פעלים ברמה אקדמית-מתקדמת - משמשים בטקסטים מדעיים, ספרותיים ומשפטיים

---

## 📋 קטגוריות:
1. **פעלי מחקר וטיעון אקדמי** (1001-1030) - 30 מילים
2. **פעלי ביקורת ודיון** (1031-1060) - 30 מילים
3. **פעלי שינוי ועיצוב** (1061-1090) - 30 מילים
4. **פעלי יחסים והשפעה** (1091-1120) - 30 מילים
5. **פעלים פורמליים מתקדמים** (1121-1150) - 30 מילים

---

# 🔬 קטגוריה 1: פעלי מחקר וטיעון אקדמי (30 מילים)

### 1001. **assert** (v.)
- **Definition:** to state firmly
- **תרגום:** לטעון בתוקף
- **Example 1:** She **asserted** her rights.
- **Example 2:** The author **asserts** that climate change is man-made.
- **Synonyms:** claim, declare, maintain
- **Antonyms:** deny
- **💡 Memory tip:** חזק יותר מ-`state` - טיעון בתוקף.

### 1002. **claim** (v.)
- **Definition:** to state without proof
- **תרגום:** לטעון
- **Example 1:** He **claims** to be innocent.
- **Example 2:** The company **claims** to be eco-friendly.
- **Synonyms:** assert, maintain
- **💡 Memory tip:** טיעון שעשוי להיות נכון או לא.

### 1003. **contend** (v.)
- **Definition:** to argue strongly
- **תרגום:** לטעון, להתמודד
- **Example 1:** Scientists **contend** that the theory is flawed.
- **Example 2:** She had to **contend** with many problems.
...
- **Example 2:** We **postulate** that gravity is universal.
...
- **Example 2:** We can **hypothesize** the outcome.
...
- **Example 2:** The media **speculated** about the result.
...
- **Example 2:** We can **deduce** the cause.
...
- **Example 2:** Readers must **infer** the meaning.
...
- **Example 2:** Documents **substantiate** the story.
...
- **Example 2:** The evidence **corroborates** our theory.
...
- **Example 2:** She **refuted** his argument.
...
- **Example 2:** The companies **disputed** the contract.
...
- **Example 2:** I **challenge** you to a game.
...
- **Example 2:** The government **acknowledged** the problem.
...
- **Example 2:** The painting is **attributed** to Picasso.
...
- **Example 2:** The poem is **ascribed** to an unknown author.
...
- **Example 2:** His knowledge **encompasses** history and science.
...
- **Example 2:** We should **incorporate** her ideas.
...
- **Example 2:** Immigrants **integrate** into society.
...
- **Example 2:** She **synthesized** information from many sources.
...
- **Example 2:** She **constructed** a strong argument.
...
- **Example 2:** He **derives** satisfaction from his work.
...
- **Example 2:** Where did this idea **originate**?
...
- **Example 2:** A new opportunity has **arisen**.
- **Synonyms:** emerge, appear
- **💡 Memory tip:** Forms: arise/arises/arose/arisen.
...
- **Example 2:** The action was widely **condemned**.
...
- **Example 2:** He **denounced** the corruption.
...
- **Example 2:** She **critiqued** the film's direction.
...
- **Example 2:** She was **dismissed** from her job.
- **Synonyms:** reject, fire
...
- **Example 2:** Sales have **declined** recently.
...
- **Example 2:** She **opposes** his ideas.
- **Synonyms:** object, contest
- **Antonyms:** support
...
- **Example 2:** I **protest** this decision.
...
- **Example 2:** He **advocates** a healthy lifestyle.
...
- **Example 2:** The doctor **endorses** this product.
...
- **Example 2:** Countries **sanctioned** the regime.
...
- **Example 2:** He was **commended** for bravery.
...
- **Example 2:** I **applaud** your decision.
...
- **Example 2:** She was **ridiculed** by her peers.
...
- **Example 2:** He was **scorned** by his peers.
...
- **Example 2:** She **despises** cruelty.
...
- **Example 2:** She **loathes** mornings.
...
- **Example 2:** I **resent** that remark.
...
- **Example 2:** They **embraced** after a long separation.
- **Synonyms:** accept, hug
- **Antonyms:** reject
...
- **Example 2:** She **welcomed** the change.
...
- **Example 2:** She **disregarded** my advice.
...
- **Example 2:** He **neglected** his studies.
- **Synonyms:** ignore, overlook
...
- **Example 2:** The hotel **overlooks** the sea.
...
- **Example 2:** I'm **contemplating** a career change.
...
- **Example 2:** She often **ponders** life's meaning.
...
- **Example 2:** The mirror **reflects** light.
...
- **Example 2:** Don't **dwell** on the past.
- **Synonyms:** live; linger
...
- **Example 2:** Please **amend** the document.
...
- **Example 2:** The laws were **revised**.
- **Synonyms:** edit, amend
...
- **Example 2:** The process was **refined** over years.
...
- **Example 2:** I need to **polish** my English.
...
- **Example 2:** He **perfected** his art over years.
...
- **Example 2:** The book was **augmented** with new chapters.
...
- **Example 2:** Don't **diminish** her achievement.
...
- **Example 2:** She tried to **minimize** the damage.
...
- **Example 2:** The company wants to **maximize** profits.
- **Synonyms:** optimize
- **Antonyms:** minimize
...
- **Example 2:** The system was **optimized** for speed.
...
- **Example 2:** The new system **streamlines** the workflow.
...
- **Example 2:** The restaurant was completely **revamped**.
...
- **Example 2:** The hotel was recently **renovated**.
...
- **Example 2:** **Restore** the file from backup.
...
- **Example 2:** The roof needs **repair**.
- **Synonyms:** fix, mend
...
- **Example 2:** She **demolished** his argument.
...
- **Example 2:** We must **eliminate** this problem.
...
- **Example 2:** The disease was **eradicated**.
...
- **Example 2:** They want to **abolish** that tax.
...
- **Example 2:** The offer was **revoked**.
...
- **Example 2:** Operations were **suspended**.
...
- **Example 2:** The game was **postponed**.
...
- **Example 2:** Don't **delay** the decision.
...
- **Example 2:** She **deferred** her decision.
...
- **Example 2:** This will **hasten** the process.
...
- **Example 2:** We need to **accelerate** progress.
...
- **Example 2:** **Decelerate** before the curve.
- **Synonyms:** slow down
- **Antonyms:** accelerate
...
- **Example 2:** **Terminate** the call now.
- **Synonyms:** end, finish
- **Antonyms:** start
...
- **Example 2:** Please **finalize** the document.
...
- **Example 2:** The company **consolidated** its divisions.
- **Synonyms:** combine, unify
- **💡 Memory tip:** `con-` + `solid` = להפוך ליחידה מוצקה.
...
- **Example 2:** The weather **influenced** our decision.
...
- **Example 2:** This decision will **impact** millions.
...
- **Example 2:** The sculptor **molded** the clay.
- **Synonyms:** shape, form
...
- **Example 2:** He **inspires** his students.
...
- **Example 2:** She knows how to **motivate** people.
...
- **Example 2:** She **persuaded** me to try.
...
- **Example 2:** You can't **dissuade** me.
- **Synonyms:** discourage
- **Antonyms:** persuade
...
- **Example 2:** He **manipulated** the machine carefully.
...
- **Example 2:** She **exploited** the opportunity.
...
- **Example 2:** We **utilize** new technology.
- **Synonyms:** use, employ
...
- **Example 2:** She **employed** a clever strategy.
- **Synonyms:** hire; use
- **💡 Memory tip:** שני מובנים.
...
- **Example 2:** He **engaged** in the discussion.
...
- **Example 2:** Scientists **collaborate** globally.
...
- **Example 2:** The countries **cooperated** on trade.
...
- **Example 2:** She **competed** in the Olympics.
...
- **Example 2:** Technology **dominates** modern life.
...
- **Example 2:** We must **confront** this problem.
...
- **Example 2:** She **resolved** to quit smoking.
...
- **Example 2:** The UN **mediates** conflicts.
...
- **Example 2:** They **negotiated** a peace deal.
...
- **Example 2:** Don't **compromise** your values.
...
- **Example 2:** He **conceded** the election.
...
- **Example 2:** She wouldn't **yield** to pressure.
...
- **Example 2:** Don't **surrender** to fear.
...
- **Example 2:** They **resisted** the invasion.
- **Synonyms:** oppose, fight
- **Antonyms:** surrender
...
- **Example 2:** Parents **protect** their children.
...
- **Example 2:** She **defended** her thesis.
- **Synonyms:** protect, support
- **Antonyms:** attack
...
- **Example 2:** Critics **attacked** his book.
- **Synonyms:** assault, assail
- **Antonyms:** defend
- **💡 Memory tip:** פיזי או מילולי.
...
- **Example 2:** The police **pursued** the suspect.
- **Synonyms:** chase, seek
...
- **Example 2:** She **sought** advice from experts.
...
- **Example 2:** We **undertake** to complete it.
...
- **Example 2:** They **conducted** an interview.
...
- **Example 2:** Changes were **implemented** gradually.
...
- **Example 2:** The prisoner was **executed**.
...
- **Example 2:** The project is **proceeding** well.
...
- **Example 2:** She **facilitated** the meeting.
- **Synonyms:** ease, help
- **Antonyms:** hinder
...
- **Example 2:** The rain **hindered** the work.
...
- **Example 2:** Nothing will **impede** my success.
...
- **Example 2:** A fallen tree **obstructed** the road.
...
- **Example 2:** The situation **deteriorated** rapidly.
...
- **Example 2:** The weather is **worsening**.
...
- **Example 2:** Plants **flourish** in spring.
...
- **Example 2:** This plant **thrives** in the sun.
...
- **Example 2:** Without water, plants will **perish**.
- **Synonyms:** die, expire
...
- **Example 2:** Their love **endured** many years.
- **Synonyms:** bear, last
- **💡 Memory tip:** שני מובנים.
...
- **Example 2:** She **persisted** despite obstacles.
...
- **Example 2:** She **persevered** through hard times.
...
- **Example 2:** She **strives** to be her best.
...
- **Example 2:** We **aspire** to greatness.
- **Synonyms:** aim, desire
...
- **Example 2:** Exercise **elevates** mood.
- **Synonyms:** raise, lift
- **Antonyms:** lower
...
- **Example 2:** His work **exemplifies** excellence.
...
- **Example 2:** This **constitutes** a violation.
...
- **Example 2:** We **encountered** problems.
- **Synonyms:** meet, face
- **💡 Memory tip:** גם שם עצם.
...
- **Example 2:** We must **grapple** with this issue.
...
- **Example 2:** She **tackled** the challenge.
...
- **Example 2:** She **withstood** the criticism.
- **Synonyms:** resist, endure
- **💡 Memory tip:** Forms: withstand/withstands/withstood/withstood.

---

# 📋 סיכום חלק א' - 150 פעלים Advanced

## ✅ סיימתם את חלק הפעלים של חבילה 3!

**הקטגוריות שלמדתם:**
- 🔬 פעלי מחקר וטיעון אקדמי (30 מילים)
- 💬 פעלי ביקורת ודיון (30 מילים)
- 🔨 פעלי שינוי ועיצוב (30 מילים)
- 🤝 פעלי יחסים והשפעה (30 מילים)
- 📜 פעלים פורמליים מתקדמים (30 מילים)
...
בחלק ב' של חבילה 3 נלמד **200 שמות עצם Advanced** - מושגים אקדמיים מתקדמים.

**[⏭️ חלק ב' - 200 שמות עצם Advanced](./vocabulary_3_advanced_part_b_nouns.md)**
