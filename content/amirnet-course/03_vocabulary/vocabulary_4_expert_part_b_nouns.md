...
## חלק ב': 200 שמות עצם (Nouns) - רמה מומחה

**מבנה:** 200 שמות עצם ברמה הגבוהה ביותר - מונחים אקדמיים מתוחכמים, ספרותיים ונדירים

---

## 📋 קטגוריות:
1. **מושגים ספרותיים ורטוריים** (1651-1690) - 40 מילים
2. **מונחים אקדמיים פילוסופיים** (1691-1730) - 40 מילים
3. **מונחים פסיכולוגיים מתקדמים** (1731-1770) - 40 מילים
4. **מושגים היסטוריים וחברתיים** (1771-1810) - 40 מילים
5. **מונחים פורמליים נדירים** (1811-1850) - 40 מילים

---

# 📖 קטגוריה 1: מושגים ספרותיים ורטוריים (40 מילים)

### 1651. **rhetoric** (n.)
- **Definition:** the art of persuasive speaking
- **תרגום:** רטוריקה
- **Example 1:** His **rhetoric** was powerful.
- **Example 2:** Political **rhetoric** can be misleading.
- **Synonyms:** oratory, eloquence
- **💡 Memory tip:** `rhetorical` (adj).

### 1652. **discourse** (n.)
- **Definition:** written or spoken communication
- **תרגום:** שיח
- **Example 1:** Academic **discourse** is formal.
- **Example 2:** A philosophical **discourse**.
- **Synonyms:** debate, discussion
- **💡 Memory tip:** רמה גבוהה של דיון.
...
- **Example 2:** The **dialogue** in this novel is natural.
...
- **Example 2:** His **monologue** lasted an hour.
...
- **Example 2:** She performed a moving **soliloquy**.
- **Synonyms:** monologue
...
- **Example 2:** The **allegory** represents society.
...
- **Example 2:** The **parable** teaches kindness.
...
- **Example 2:** Dramatic **irony** creates tension.
...
- **Example 2:** Dripping with **sarcasm**.
...
- **Example 2:** **Satire** exposes corruption.
...
- **Example 2:** **Parody** makes us laugh.
...
- **Example 2:** A political **caricature**.
...
- **Example 2:** **Prose** and poetry differ.
- **Synonyms:** writing
...
- **Example 2:** **Poetry** expresses emotion.
...
- **Example 2:** The second **verse** is beautiful.
...
- **Example 2:** The poem has four **stanzas**.
- **Synonyms:** verse
...
- **Example 2:** Change the **narrative**.
...
- **Example 2:** We identify with the **protagonist**.
- **Synonyms:** hero, main character
- **Antonyms:** antagonist
- **💡 Memory tip:** `pro-` = בעד.
...
- **Example 2:** Every story needs an **antagonist**.
- **Synonyms:** opponent, villain
...
- **Example 2:** The story builds to a **climax**.
...
- **Example 2:** A satisfying **denouement**.
...
- **Example 2:** The **motif** runs throughout.
...
- **Example 2:** **Imagery** evokes emotions.
...
- **Example 2:** The **tone** of the article.
...
- **Example 2:** **Style** matters in fashion.
...
- **Example 2:** Different **genres** appeal to different people.
...
- **Example 2:** Ancient **manuscripts** are precious.
...
- **Example 2:** I prefer **fiction** to reality.
- **Synonyms:** stories, novels
...
- **Example 2:** An engaging **autobiography**.
- **Synonyms:** memoir
...
- **Example 2:** The **treatise** is scholarly.
...
- **Example 2:** Writing a **dissertation** is hard.
- **Synonyms:** thesis
...
- **Example 2:** His **critique** was fair.
...
- **Example 2:** His political **commentary**.
...
- **Example 2:** Studies in **epistemology**.
...
- **Example 2:** Aristotle wrote on **metaphysics**.
...
- **Example 2:** Questions of **ontology**.
...
- **Example 2:** **Dogma** can stifle thinking.
...
- **Example 2:** The **doctrine** of democracy.
...
- **Example 2:** The **tenets** of democracy.
...
- **Example 2:** It's an **axiom** that honesty pays.
...
- **Example 2:** He writes witty **aphorisms**.
...
- **Example 2:** Start with a strong **premise**.
...
- **Example 2:** An **exemplar** of good design.
...
- **Example 2:** She's the **archetype** of a good teacher.
...
- **Example 2:** Build a **prototype** first.
...
- **Example 2:** She's a **paragon** of honesty.
...
- **Example 2:** The **epitome** of style.
...
- **Example 2:** The **embodiment** of evil.
...
- **Example 2:** The **manifestations** vary.
...
- **Example 2:** At the moment of **conception**.
...
- **Example 2:** **Preconceptions** limit us.
...
- **Example 2:** Clear up the **misconception**.
...
- **Example 2:** Support your **assertions**.
...
- **Example 2:** The **proposition** is debatable.
...
- **Example 2:** Einstein's **postulates**.
...
- **Example 2:** The **inference** is clear.
...
- **Example 2:** The **induction** ceremony.
...
- **Example 2:** The **rationale** is sound.
...
- **Example 2:** The **fallacy** in his argument.
...
- **Example 2:** The **antithesis** of kindness.
...
- **Example 2:** **Synthesis** of the findings.
...
- **Example 2:** **Juxtaposition** creates contrast.
...
- **Example 2:** The **dichotomy** of good and evil.
...
- **Example 2:** Appreciate the **subtleties**.
...
- **Example 2:** The **abstraction** of numbers.
...
- **Example 2:** **Conceptualization** takes time.
- **Synonyms:** formulation, abstraction
- **💡 Memory tip:** מ-`conceptualize`.
...
- **Example 2:** Age affects **cognition**.
...
- **Example 2:** Follow your **instincts**.
...
- **Example 2:** Stored in the **subconscious**.
...
- **Example 2:** The collective **unconscious**.
...
- **Example 2:** The movie is a **sensation**.
...
- **Example 2:** **Compulsion** to check the door.
...
- **Example 2:** An **obsession** with cleanliness.
...
- **Example 2:** No **remorse** for his actions.
...
- **Example 2:** What an **embarrassment**!
...
- **Example 2:** She couldn't face the **humiliation**.
...
- **Example 2:** Maintain your **dignity**.
...
- **Example 2:** Her **integrity** is unquestionable.
...
- **Example 2:** Low **morale** hurts productivity.
...
- **Example 2:** Strengthen your **resolve**.
...
- **Example 2:** Success requires **determination**.
...
- **Example 2:** **Tenacity** overcomes obstacles.
- **Synonyms:** persistence, determination
...
- **Example 2:** Her **fortitude** inspired others.
...
- **Example 2:** Her **compassion** is inspiring.
...
- **Example 2:** True **altruism** is rare.
...
- **Example 2:** **Narcissism** harms relationships.
...
- **Example 2:** Damaged **psyche**.
- **Synonyms:** mind, soul
- **💡 Memory tip:** `psychology` = מ-psyche.
...
- **Example 2:** Western **civilization**.
...
- **Example 2:** Studies of **antiquity**.
...
- **Example 2:** **Modernity** brought change.
...
- **Example 2:** Preserve for **posterity**.
...
- **Example 2:** Direct **descendants** of the king.
- **Synonyms:** offspring, heir
- **Antonyms:** ancestor
...
- **Example 2:** Honor your **ancestors**.
...
- **Example 2:** Critics call it an **oligarchy**.
- **Synonyms:** elite rule
...
- **Example 2:** An **aristocracy** of intellect.
...
- **Example 2:** Middle-class **bourgeoisie**.
...
- **Example 2:** Empower the **proletariat**.
...
- **Example 2:** Social **hierarchies** exist everywhere.
...
- **Example 2:** Challenge the **status quo**.
...
- **Example 2:** Scientific **consensus**.
...
- **Example 2:** Growing **polarization**.
...
- **Example 2:** The party faced a **schism**.
...
- **Example 2:** A **coalition** government.
...
- **Example 2:** International **diplomacy**.
...
- **Example 2:** **Sovereignty** was restored.
...
- **Example 2:** Women's **emancipation**.
...
- **Example 2:** Seek **liberation** from stress.
...
- **Example 2:** Political **oppression**.
...
- **Example 2:** **Tyranny** of the majority.
...
- **Example 2:** Benevolent **despotism**.
...
- **Example 2:** Not chaos but **anarchy**.
...
- **Example 2:** The **upheaval** changed everything.
...
- **Example 2:** The country is in **turmoil**.
...
- **Example 2:** Political **stability**.
- **Synonyms:** steadiness, balance
- **Antonyms:** instability
- **💡 Memory tip:** `stable` (adj).
...
- **Example 2:** An earthquake of **magnitude** 7.
...
- **Example 2:** The many **facets** of the problem.
...
- **Example 2:** Great **breadth** of vision.
...
- **Example 2:** At the **height** of her career.
...
- **Example 2:** The **pinnacle** of achievement.
...
- **Example 2:** The **zenith** of civilization.
- **Synonyms:** peak, apex
- **Antonyms:** nadir
...
- **Example 2:** The **apex** of his career.
- **Synonyms:** peak, summit
...
- **Example 2:** Economic **nadir**.
- **Synonyms:** low point, bottom
- **Antonyms:** zenith
- **💡 Memory tip:** ספרותי.
...
- **Example 2:** The **gist** of his speech.
...
- **Example 2:** The **nucleus** of the team.
...
- **Example 2:** The **culmination** of her career.
...
- **Example 2:** The **periphery** of the city.
- **Synonyms:** edge, outskirts
...
- **Example 2:** At regular **intervals**.
...
- **Example 2:** The show is on **hiatus**.
- **Synonyms:** pause, break
- **💡 Memory tip:** פורמלי וספרותי.
...
- **Example 2:** No **respite** from work.
- **Synonyms:** rest, break
- **💡 Memory tip:** ספרותי.
...
- **Example 2:** The **lull** before the storm.
...
- **Example 2:** **Commencement** ceremony.
...
- **Example 2:** The **inception** of the idea.
- **Synonyms:** beginning, start
...
- **Example 2:** Before the **advent** of TV.
...
- **Example 2:** Clear from the **outset**.
- **Synonyms:** beginning, start
...
- **Example 2:** The **aftermath** was devastating.
...
- **Example 2:** Small **remnants** of hope.
...
- **Example 2:** Historical **monuments**.
...
- **Synonyms:** proof, witness
- **💡 Memory tip:** גם: צוואה.

---

# 📋 סיכום חלק ב' - 200 שמות עצם Expert

## ✅ סיימתם את חלק שמות העצם של חבילה 4!

**הקטגוריות שלמדתם:**
- 📖 מושגים ספרותיים ורטוריים (40)
- 🧠 מונחים אקדמיים פילוסופיים (40)
- 🧘 מונחים פסיכולוגיים מתקדמים (40)
- 🌍 מושגים היסטוריים וחברתיים (40)
- 📚 מונחים פורמליים נדירים (40)
...
בחלק ג' של חבילה 4 נלמד **100 תארים ברמת Expert** - תארים ספרותיים נדירים.

**[⏭️ חלק ג' - 100 תארים](./vocabulary_4_expert_part_c_adjectives.md)**
